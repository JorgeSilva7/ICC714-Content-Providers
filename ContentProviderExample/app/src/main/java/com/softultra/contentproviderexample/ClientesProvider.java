...
public class ClientesProvider extends ContentProvider {
    ...
    private static final String uri =
            "content://com.softultra.contentproviderexample/clientes";
    ...
    static {
        ...
        uriMatcher.addURI("com.softultra.contentproviderexample", "clientes", CLIENTES);
        uriMatcher.addURI("com.softultra.contentproviderexample", "clientes/#", CLIENTES_ID);
    }
    ...
    public String getType(Uri uri) {
        ...
        {
            case CLIENTES:
                return "vnd.android.cursor.dir/vnd.softultra.cliente";
            case CLIENTES_ID:
                return "vnd.android.cursor.item/vnd.softultra.cliente";
            default:
                return null;
        }
    }
